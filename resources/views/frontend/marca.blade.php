...
<head>
  ...
  <title>{{ ucfirst($marca) }} - Technova</title>
...
<div class="filters-bar">
  ...
  <select id="marca-select" onchange="redirectBrand(this.value)">
    ...
    <option value="oppo" {{ $marca == 'oppo' ? 'selected' : '' }}>📲 OPPO</option>
...
<div class="marca-header">
  <h1>
    @if($marca == 'apple')
      🍎 Apple
    @elseif($marca == 'samsung')
      📱 Samsung
    @elseif($marca == 'motorola')
      📞 Motorola
    @elseif($marca == 'xiaomi')
      🧡 Xiaomi
    @elseif($marca == 'oppo')
...
@else
  <div class="no-productos">
    ...
    <p>No se encontraron productos de la marca <strong>{{ ucfirst($marca) }}</strong>.</p>
